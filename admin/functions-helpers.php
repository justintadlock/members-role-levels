...
function mrl_get_role_levels() {
	...
	return array(
		'level_0'  => __( 'Level 0',  'members-role-levels' ),
		'level_1'  => __( 'Level 1',  'members-role-levels' ),
		'level_2'  => __( 'Level 2',  'members-role-levels' ),
		'level_3'  => __( 'Level 3',  'members-role-levels' ),
		'level_4'  => __( 'Level 4',  'members-role-levels' ),
		'level_5'  => __( 'Level 5',  'members-role-levels' ),
		'level_6'  => __( 'Level 6',  'members-role-levels' ),
		'level_7'  => __( 'Level 7',  'members-role-levels' ),
		'level_8'  => __( 'Level 8',  'members-role-levels' ),
		'level_9'  => __( 'Level 9',  'members-role-levels' ),
		'level_10' => __( 'Level 10', 'members-role-levels' )
	);
}
